...
SET(${v} \"${${v}}\")")
  ...
  # Update CTKAPPLAUNCHER_TARGET with its output name if it applies
  IF(CTKAPPLAUNCHER_TARGET_OUTPUT_NAME)
    SET(CTKAPPLAUNCHER_TARGET ${CTKAPPLAUNCHER_TARGET_OUTPUT_NAME})
  ENDIF()
