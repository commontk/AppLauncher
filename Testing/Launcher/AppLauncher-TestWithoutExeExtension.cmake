...
# --------------------------------------------------------------------------
# Attempt to start launcher from its directory without
# specifying .exe file extension.

get_filename_component(launcher_dir ${launcher_exe} DIRECTORY)
get_filename_component(launcher_filename_without_extension ${launcher_exe} NAME_WE)
set(launcher_without_exe "${launcher_dir}/${launcher_filename_without_extension}")

set(command ${launcher_without_exe} --launcher-no-splash --launch ${application} --print-current-working-directory)
execute_process(
  COMMAND ${command}
...
if(rv)
  message(FATAL_ERROR "[${launcher_without_exe}] failed to start application [${application}] from "
...
set(command ${launcher_without_exe} --launcher-no-splash --launch <APPLAUNCHER_DIR>/${relative_application} --print-current-working-directory)
execute_process(
  COMMAND ${command}
  WORKING_DIRECTORY ${launcher_working_dir}
  OUTPUT_VARIABLE ov
