...
// --------------------------------------------------------------------------
// ctkAppLauncherCommandLineParser::ctkInternal class

// --------------------------------------------------------------------------
class ctkAppLauncherCommandLineParser::ctkInternal
{
public:
  ...
  #define ctkAppLauncherCommandLineParser_ctkInternal_declare_map(_NAME) \
  ...
  ctkAppLauncherCommandLineParser_ctkInternal_declare_map(String);
  ctkAppLauncherCommandLineParser_ctkInternal_declare_map(Boolean);
  ctkAppLauncherCommandLineParser_ctkInternal_declare_map(StringList);
  ctkAppLauncherCommandLineParser_ctkInternal_declare_map(Integer);
  
  #undef ctkAppLauncherCommandLineParser_ctkInternal_declare_map
...
// --------------------------------------------------------------------------
// ctkAppLauncherCommandLineParser::ctkInternal methods

// --------------------------------------------------------------------------
CommandLineParserArgumentDescriptionBase* 
  ctkAppLauncherCommandLineParser::ctkInternal::argumentDescription(const QString& argument)
{
...
// --------------------------------------------------------------------------
// ctkAppLauncherCommandLineParser methods

// --------------------------------------------------------------------------
ctkAppLauncherCommandLineParser::ctkAppLauncherCommandLineParser()
{
...
// --------------------------------------------------------------------------
bool ctkAppLauncherCommandLineParser::parseArguments(const QStringList& arguments)
{
  // Reset
...
// -------------------------------------------------------------------------
QString ctkAppLauncherCommandLineParser::errorString()
{
  return this->Internal->ErrorString;
}

// -------------------------------------------------------------------------
const QStringList& ctkAppLauncherCommandLineParser::unparsedArguments()
{
  return this->Internal->UnparsedArguments;
}

// -------------------------------------------------------------------------
#define ctkAppLauncherCommandLineParser_addArgument_cxx_core(_NAME, _TYPE)                 \
  ...
  // -------------------------------------------------------------------------
  #define ctkAppLauncherCommandLineParser_addArgument_cxx(_NAME, _TYPE)                        \
    void ctkAppLauncherCommandLineParser::add##_NAME##Argument(const char* longarg,            \
      const char* shortarg, _TYPE* var, const QString& argHelp, const _TYPE& defaultValue,     \
      bool ignoreRest)                                                                         \
    {                                                                                          \
    ctkAppLauncherCommandLineParser_addArgument_cxx_core(_NAME, _TYPE);                        \
    }

  // -------------------------------------------------------------------------
  #define ctkAppLauncherCommandLineParser_addArgument_cxx_without_ignore_rest(_NAME, _TYPE)    \
    void ctkAppLauncherCommandLineParser::add##_NAME##Argument(const char* longarg,            \
      const char* shortarg, _TYPE* var, const QString& argHelp, const _TYPE& defaultValue)     \
    {                                                                                          \
    bool ignoreRest = false;                                                                   \
...
// --------------------------------------------------------------------------
ctkAppLauncherCommandLineParser_addArgument_cxx(String, QString);
ctkAppLauncherCommandLineParser_addArgument_cxx(Boolean, bool);
ctkAppLauncherCommandLineParser_addArgument_cxx_without_ignore_rest(StringList, QStringList);
ctkAppLauncherCommandLineParser_addArgument_cxx(Integer, int);

#undef ctkAppLauncherCommandLineParser_addArgument_cxx

// --------------------------------------------------------------------------
bool ctkAppLauncherCommandLineParser::setExactMatchRegularExpression(
...
// --------------------------------------------------------------------------
QString ctkAppLauncherCommandLineParser::helpText(const char charPad)
{
  QString text;
  QTextStream stream(&text);
...
// --------------------------------------------------------------------------
bool ctkAppLauncherCommandLineParser::argumentAdded(const QString& argument)
{
  return this->Internal->ArgNameToArgumentDescriptionMap.contains(argument);
}

// --------------------------------------------------------------------------
bool ctkAppLauncherCommandLineParser::argumentParsed(const QString& argument)
{
