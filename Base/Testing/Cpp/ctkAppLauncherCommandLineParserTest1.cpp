...
int ctkAppLauncherCommandLineParserTest1(int, char*[])
{
  // Test1 - Check if unparsedArguments() worked as expected
  QStringList arguments1;
  arguments1 << "ctkAppLauncherCommandLineParserTest1";
  arguments1 << "--test-bool";
  arguments1 << "--test-string";
  arguments1 << "ctkrocks";
  ctkAppLauncherCommandLineParser parser1;
  ...
  arguments2 << "ctkAppLauncherCommandLineParserTest1";
  arguments2 << "--test-bool";
  arguments2 << "--test-string";
  arguments2 << "ctkrocks";
  bool testBool = false;
  ctkAppLauncherCommandLineParser parser2;
  ...
  arguments3 << "ctkAppLauncherCommandLineParserTest1";
  ...
  ctkAppLauncherCommandLineParser parser3;
  ...
  ctkAppLauncherCommandLineParser parser4;
  QString helpString;
  QString helpString1;
  QString helpString2;
  QString helpString3;
  ...
  ctkAppLauncherCommandLineParser parser5;
  ...
  arguments5 << "ctkAppLauncherCommandLineParserTest1";
  ...
  ctkAppLauncherCommandLineParser parser6;
  QString test6String;
  ...
  arguments6 << "ctkAppLauncherCommandLineParserTest1"
             << "--string";
  ...
  ctkAppLauncherCommandLineParser parser7;
  ...
  arguments7 << "ctkAppLauncherCommandLineParserTest1";
  arguments7 << "--bool";
  ...
  ctkAppLauncherCommandLineParser parser8;
  QString test8String;
  ...
  arguments8 << "ctkAppLauncherCommandLineParserTest1";
  ...
  ctkAppLauncherCommandLineParser parser10;
  ...
  arguments10 << "ctkAppLauncherCommandLineParserTest1";
  arguments10 << "--bool";
